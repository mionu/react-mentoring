...
const getMoviesListFailure = (error) => ({ type: ActionTypes.GET_MOVIES_LIST_FAILURE, payload: error });
...
const getMovieByIdSuccess = (movie) => ({ type: ActionTypes.GET_MOVIE_BY_ID_SUCCESS, payload: movie });
const getMovieByIdFailure = (error) => ({ type: ActionTypes.GET_MOVIE_BY_ID_FAILURE, payload: error });
