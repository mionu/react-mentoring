...
describe('moviesEpics', () => {
    ...
    describe('getMovieByIdEpic', () => {
        it('should return movie', (done) => {
            ...
            const expectedActions = [setGlobalLoading(true), setGlobalLoading(false), getMovieByIdSuccess(mockMovie)];
        ...
        it('should handle error', (done) => {
            const error = { error: 'unknown' };
            const expectedActions = [setGlobalLoading(true), setGlobalLoading(false), getMovieByIdFailure(error)];
            dependencies.ajax.getJSON.mockReturnValueOnce(throwError(error));
